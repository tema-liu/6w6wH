...
import { Reply, ResponseData } from "../type/type"; // 假設型別定義在 types 檔案中
...
export const postCommentReply = async (
  ...
  const url = `${apiUrl}/api/comments/reply`;
  // 檢查 HTTP 回應是否成功
  const options = {
    method: "POST",
  ...
  try {
    ...
    console.log("回覆評論結果: " + JSON.stringify(json));
